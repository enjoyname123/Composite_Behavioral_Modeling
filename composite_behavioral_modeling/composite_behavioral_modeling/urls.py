...
urlpatterns = [
    ...
    url(r'^Predict_Theft_Status/$', remoteuser.Predict_Theft_Status, name="Predict_Theft_Status"),
    ...
    url(r'^View_Theft_Status_Ratio/$', serviceprovider.View_Theft_Status_Ratio, name="View_Theft_Status_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_Theft_Status/$', serviceprovider.View_Prediction_Of_Theft_Status, name="View_Prediction_Of_Theft_Status"),
